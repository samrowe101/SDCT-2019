---
title: "Randomized controlled non-inferiority trial investigating the effect of two selective dry cow therapy protocols on antibiotic use and udder health - quarter-level outcomes"
...
### Analysis was conducted using R-studio and STATA. Use the tabs above to navigate between the two. 
...
```{r}
table1::table1(~ factor(FARMID) + Spectramast + Age + Parity + factor(IMIDO) + DOSCC + DOMY + DODIM + PrevCM + PrevSCCHI + DPlength + PCSampDIM | Tx, data=SDCTQTR,topclass="Rtable1-zebra")
```
...
## Steps 1-2 of model building were conducted in R (this document).
## Refer to STATA log file for steps 3-6. 
